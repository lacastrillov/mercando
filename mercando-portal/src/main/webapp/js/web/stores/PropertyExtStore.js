...
function PropertyExtStore(){
    ...
    Instance.save= function(operation, data, func){
        ...
        Ext.Ajax.request({
            url: Ext.context+"/rest/property/"+operation+".htm",
            method: "POST",
    ...
    Instance.load= function(idEntity, func){
        Ext.Ajax.request({
            url: Ext.context+"/rest/property/load.htm",
            method: "GET",
    ...
    Instance.upload= function(form, idEntity, func){
        form.submit({
            url: Ext.context+"/rest/property/diskupload/"+idEntity+".htm",
    ...
    Instance.deleteByFilter= function(filter, func){
        ...
        Ext.Ajax.request({
            url: Ext.context+"/rest/property/delete/byfilter.htm",
            method: "GET",
